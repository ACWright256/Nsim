...
from .minimal_classes import ReceptorResponse, ReceptionToken
...
class Receptor:
    ...
    def receive(self, nt_count):
        ...
        Outputs:
            ...
            neuron sensitivity.
        """
        if self.response_type==ReceptorResponse.EXCITORY:
            return self._excitory_reception(nt_count)
        elif self.response_type==ReceptorResponse.INHIBITORY:
            return self._inhibitory_reception(nt_count)
        elif self.response_type==ReceptorResponse.MODULATORY:
    ...
    def _excitory_reception(self,nt_count):
        ...
        #return ReceptionToken(relative_strength=self.input_sensitivity, activation=1)
